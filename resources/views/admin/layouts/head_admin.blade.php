<meta charset="UTF-8">
<meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">    <title>Bon de Commande</title>
    <!-- Favicon-->
...
<link href="{{asset('admin-asset/plugins/morrisjs/morris.css')}}" rel="stylesheet" />
