 ...
 <?php  $countt=DB::select( "select COUNT(*)as con from ( select b.Matricule,b.Structure, c.code_ag,c.nom_ag,c.WilayaAg,c.CommuneAg ,c.Nom_DR ,a.notifiable_type,a.data,a.type
                      ...
                      @endif
                        ...
                        <ul class="dropdown-menu">
                            <li class="header">NOTIFICATIONS  Bon De Commande</li>
                            <li class="body">
...
@foreach ( App\Notification::where('type', 'App\Notifications\NouveauxBonDeCommande')->latest('created_at') ->get() as $notification) 
                                    ...
                                    <li>
                                        <a href="javascript:void(0);" class=" waves-effect waves-block">
                                            <div class="icon-circle bg-blue-grey">
                                                <i class="material-icons" style="bg-blue-grey:#2b982b !important">comment</i>
                                            </div>
                                            <div class="menu-info">
                                                <h4><b>{{ $notification->data['email'] }}</b> </h4>
                                                <p>
                                                    <i class="material-icons">access_time</i>vient d'envoyer BC: {{ Carbon\Carbon::parse($notification->created_at)->diffForHumans()}}
                                                </p>
                                            </div>
                                        </a>
                                    </li>
                                    ...
                                    @elseif ($user->role_id == 2)  
<?php  $userss= DB::select("  select b.Matricule,b.Structure, c.code_ag,c.nom_ag,c.WilayaAg,c.CommuneAg ,c.Nom_DR ,a.notifiable_type,a.data,a.type,a.created_at,a.notifiable_id
                           from  [espace_client2].[dbo].notifications as a
                            inner join [espace_client2].[dbo]._busers as b
                                                   on a.notifiable_id = b.Structure
                            inner join [espace_client2].[dbo].Bagences as c
                                                  on b.Structure = c.code_ag
                                                 ");
                                                    ?>
                                    ...
                                    <li>
                                        <a href="javascript:void(0);" class=" waves-effect waves-block">
                                            ...
                                            <div class="menu-info">
                                                <h4><b>{{ $notification->data}}</b> vient d'envoyer BC</h4>
                                                <p>
                            ...
                            <li class="footer">
                                <a href="/NotificationsBC" class=" waves-effect waves-block">
voir toutes les notifications</a>
 ...
 <li>
                        ...
                        <li class="footer">
                            <a href="/NotificationsBCC" class=" waves-effect waves-block">View All Notifications</a>
                        </li>
                    </ul>
                    <!-- Tasks -->
...
@if ($user->role_id == 1)  
                ...
                <li class="active">
                    <a href="https://drawsql.app/ctc/diagrams/bon-de-commande" target="_blank">
                        <i class="material-icons">home</i>
                ...
                <li class="active">
                    <a href="/NotificationsBC">
                        <i class="material-icons">person</i>
                        <span> Notifications Bon de commande
</span>
                    </a>
                </li>

                <li class="active">
                    <a href="/NotificationsBCC">
                        <i class="material-icons">person</i>
                        <span> Notifications Nouveaux Client
</span>
                    </a>
                </li>
